...
今回の定例会のテーマは、    
**「あなたの価値観を明確にして、今後の仕事や人生で後悔のない選択ができるようにしよう」** です。        
...
今回のワークは、「価値観の明確化」です。    
価値観を明確にする目的は、今後の仕事や人生で後悔のない選択ができるようにするためです。
...
ワークシート_価値観リスト100:    
[ワークシート_価値観リスト100.xlsx](./ワークシート_価値観リスト100.xlsx)
...
今回のディスカッションは、    
テーブル内のメンバーでクロストークができるようになることが目的です。    
